...
kkkk5.style.visibility="visible"
  ...
  document.body.classList.add("simulation-complete");

  // Hide everything else (optional cleanup)
  const toHide = [
    brstandtai, f111, f222, f333, f444, f555v,
    knob3rd, p111, p222, p333, p444, p555,
    table111f, heading33,
    kkkk1, kkkk2, kkkk3, kkkk4, kkkk5,
    image, table111, table222, table333,
    he0, he1, he2, he3, he33
  ];
  toHide.forEach(el => el && (el.style.visibility = "hidden"));

  // Show only usertable and submit button
